...
(defclass financial-data (jquants-object)
  ((disclosed-date :accessor disclosed-date-of :initform (local-time:universal-to-timestamp 0))
   ...
   (current-period-start-date :accessor current-period-start-date-of :initform (local-time:universal-to-timestamp 0))
   (current-period-end-date :accessor current-period-end-date-of :initform (local-time:universal-to-timestamp 0))
   (current-fiscal-year-start-date :accessor current-fiscal-year-start-date-of :initform (local-time:universal-to-timestamp 0))
   (current-fiscal-year-end-date :accessor current-fiscal-year-end-date-of :initform (local-time:universal-to-timestamp 0))
   (next-fiscal-year-start-date :accessor next-fiscal-year-start-date-of :initform (local-time:universal-to-timestamp 0))
   (next-fiscal-year-end-date :accessor next-fiscal-year-end-date-of :initform (local-time:universal-to-timestamp 0))
