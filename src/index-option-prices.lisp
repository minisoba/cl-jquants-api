...
(defclass index-option-prices (jquants-object)
  ((code :accessor code-of :initform nil)
   ...
   (last-trading-day :accessor last-trading-day-of :initform (local-time:universal-to-timestamp 0))
   (special-quotation-day :accessor special-quotation-day-of :initform (local-time:universal-to-timestamp 0))
