...
(defclass financial-statement-detail-data (jquants-object)
  ((goodwill-ifrs :accessor goodwill-ifrs-of :initform 0.0)
   ...
   (previous-fiscal-year-end-date-dei :accessor previous-fiscal-year-end-date-dei-of :initform (local-time:universal-to-timestamp 0))
   ...
   (current-period-end-date-dei :accessor current-period-end-date-dei-of :initform (local-time:universal-to-timestamp 0))
   ...
   (current-fiscal-year-start-date-dei :accessor current-fiscal-year-start-date-dei-of :initform (local-time:universal-to-timestamp 0))
   ...
   (previous-fiscal-year-start-date-dei :accessor previous-fiscal-year-start-date-dei-of :initform (local-time:universal-to-timestamp 0))
   ...
   (current-fiscal-year-end-date-dei :accessor current-fiscal-year-end-date-dei-of :initform (local-time:universal-to-timestamp 0))
   ...
   (comparative-period-end-date-dei :accessor comparative-period-end-date-dei-of :initform (local-time:universal-to-timestamp 0))
...
(defclass financial-statement-data (jquants-object)
  ((disclosed-date :accessor disclosed-date-of :initform (local-time:universal-to-timestamp 0))
