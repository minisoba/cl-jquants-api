...
(defmethod send-request ((obj mock-http-handler) endpoint method
  ...
  (flet ((string-match (text endpoint)
    ...
    (cond ((string-match "equities/master" endpoint)
          ...
          ((string-match "markets/margin-alert" endpoint)
           (%mock-http-response-from-json "MarginAlert.json"))
          ((string-match "markets/short-ratio" endpoint)
           (%mock-http-response-from-json "ShortSaleValueAndRatioBySector.json"))
          ((string-match "markets/short-sale-report" endpoint)
           (%mock-http-response-from-json "ShortSaleReport.json"))
